...
' Small UserControl I make that shows nise frames like what you may see on websites
...
Sub DrawdmFrame()
    Dim I As Integer
    ' This sub is in fact the main part of the project that draws the nise frame
    ...
    If m_GradEn Then
        For I = 0 To n_BarHeight  ' this bit of code just draws a Graident bar very simple
